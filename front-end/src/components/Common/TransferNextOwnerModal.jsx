        ...
        const fetchTargets = async () => {
            try {
                ...
                setModalConfig({
                    ...
                    message: parsedError.message || "Không thể đồng bộ danh sách đối tác.",
                    type: "error"
                });
            }
        };
    ...
    const handleSubmit = (e) => {
        ...
        if (!selectedTarget.id || !selectedTarget.wallet_address) {
            setModalConfig({
                isOpen: true,
                title: "Thông Báo",
                message: "Vui lòng chọn đối tác tiếp nhận và đảm bảo địa chỉ ví hợp lệ!",
                type: "warning"
            });
            return;
        }
    ...
    return (
        <>
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-xs">
                ...
                <div className="relative z-10 bg-white rounded-2xl max-w-md w-full border shadow-xl overflow-hidden border-gray-200">
